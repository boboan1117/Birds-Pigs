...
wall5.rotation =90
local wall6 = creatwall(340,160)
local wall7 = creatwall(400,160)
local wall8 = display.newImage("beam.png",370,106)
wall8.rotation = 90
...
physics.addBody(wall6)
physics.addBody(wall7)
physics.addBody(wall8)
...
local pig3=makepig(360,160)
physics.addBody(pig3)
pig3.name=("pig")
group:insert(pig3)
